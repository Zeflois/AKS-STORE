...
<a href="{{ route('kasir.add') }}" type="button" class="btn btn-success rounded-3">Tambah Data</a>
        ...
        @foreach ($datas as $data)
            <tr>
                ...
                <td>
                    ...
                    <form class = "mt-1 form-inline" method="POST" action="{{ route('kasir.soft', $data->id_kasir) }}">
                        @csrf
                    ...
                    <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#hapusModal{{ $data->id_kasir }}">
                        Hapus
                    </button>
                    ...
                    <div class="modal fade" id="hapusModal{{ $data->id_kasir }}" tabindex="-1" aria-labelledby="hapusModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form method="POST" action="{{ route('kasir.destroy', $data->id_kasir) }}">
                                    @csrf
                                    @method('delete')
